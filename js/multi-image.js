    ...
    $(window).load(function(){
        ...
        for(var i = 0; i < begin_attachment_array.length; i++){
            if(begin_attachment_array[i] != ""){
                $(".hero-section-images").append( "<li class='image-list'><img src='"+begin_attachment_array[i]+"'></li>" );
            }
        }
        $("#upload-hero-images").click(function(){
            ...
            custom_uploader.on('select', function() {
                ...
                selection.map( function( attachment ) {
                    ...
                    $(".hero-section-images").append( "<li class='image-list'><img src='"+attachment.url+"'></li>" );
        ...
        $(".hero-section-images").click(function(){
